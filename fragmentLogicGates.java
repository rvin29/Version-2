...
public class fragmentLogicGates extends Fragment {

    public fragmentLogicGates() {
    ...
    public static fragmentLogicGates newInstance(String param1, String param2) {
        fragmentLogicGates fragment = new fragmentLogicGates();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_logic_gates, container, false);
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Itemtype").child("logicgate"), model.class)
                        .build();
